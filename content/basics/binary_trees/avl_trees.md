...
АВЛ-дерево (названо в честь изобретателей Адельсона-Вельского и Ландиса, 1962) — это первое самобалансирующееся двоичное дерево поиска. Оно гарантирует высоту $O(\log n)$ для любых операций.
...
>[!theorem]
>После каждой вставки или удаления требуется не более одного вращения (двойное вращение считается за одно) для восстановления баланса на каждом уровне. Общее количество вращений — $O(\log n)$.
